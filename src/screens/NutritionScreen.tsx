...
import { DietPlan, NutritionProfile } from '../types/nutrition';
    ...
    return (
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.mealCard}>
                ...
                {nutritionProfile.mealPlan.mealTimings.map((meal, index) => (
                    <TouchableOpacity
                        key={meal.id}
            ...
            <View style={styles.foodCard}>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.foodScroll}>
                    {foodSuggestions.protein.slice(0, 6).map((food, index) => (
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.foodScroll}>
                    {foodSuggestions.carbs.slice(0, 6).map((food, index) => (
                        <View key={index} style={styles.foodItem}>
                            <Text style={styles.foodName}>{food.name}</Text>
                            <Text style={styles.foodServing}>{food.servingSize}</Text>
                            <Text style={styles.foodCalories}>{food.calories} cal</Text>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.foodScroll}>
                    {foodSuggestions.fats.slice(0, 6).map((food, index) => (
                        <View key={index} style={styles.foodItem}>
                            <Text style={styles.foodName}>{food.name}</Text>
                            <Text style={styles.foodServing}>{food.servingSize}</Text>
                            <Text style={styles.foodCalories}>{food.calories} cal</Text>
