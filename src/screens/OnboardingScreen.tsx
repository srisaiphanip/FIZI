...
const ONBOARDING_SLIDES = [
    {
        ...
        description: 'Get real-time form feedback using advanced pose detection technology.',
        color: '#6C63FF',
    },
    {
        id: '2',
        ...
        description: 'Monitor your workouts, reps, and form scores over time.',
        color: '#00C853',
    },
    {
        id: '3',
        ...
        description: 'Level up your avatar and unlock achievements as you train.',
        color: '#FFB800',
    },
    {
        id: '4',
        ...
        description: 'Let\'s begin your fitness journey with perfect form!',
        color: '#FF6B6B',
    },
];
